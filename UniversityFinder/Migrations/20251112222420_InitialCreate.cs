    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SearchHistory_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CostOfLiving", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CostOfLiving_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acronym = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    CountryId = table.Column<int>(type: "INTEGER", nullable: false),
                    CityId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavorites_Universities_UniversityId",
                        column: x => x.UniversityId,
                        principalTable: "Universities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistory_SubjectId",
                table: "SearchHistory",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_UniversityId",
                table: "UserFavorites",
                column: "UniversityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_UserId_UniversityId",
                table: "UserFavorites",
